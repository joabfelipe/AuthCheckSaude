...
function App() {
  ...
  const openMaps = () => {
    const query = encodeURIComponent('Av. do Cursino, 2012 - Jardim da Saúde, São Paulo - SP');
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.1 }}>
              <span style={{ fontWeight: 900, fontSize: '1.2rem', color: '#000' }}>
                Auto Check Saúde
              </span>
              <span style={{ fontSize: '0.85rem', color: '#666' }}>
                Oficina mecânica • Jardim da Saúde
              </span>
            </div>
          </div>
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                >
                  <button
                    ...
                    onClick={() => openWhatsApp('Gostaria de agendar um check-up para meu veículo.')}
                  >
                    📋 Agendar Check-up
                  </button>
                  <button
                    ...
                    onClick={() => openWhatsApp('Preciso de um orçamento para meu veículo.')}
                  >
                    💰 Solicitar Orçamento
                  </button>
                </div>
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
              <div style={{ position: 'relative', borderRadius: '15px', overflow: 'hidden', height: '250px' }}>
                <img src="/images/foto2.jpg" alt="Interior da oficina" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                <div
                  style={{
                    position: 'absolute',
                    bottom: 0,
              ...
              <div style={{ position: 'relative', borderRadius: '15px', overflow: 'hidden', height: '250px' }}>
                <img src="/images/foto3.jpg" alt="Equipamentos modernos" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                <div
                  style={{
                    position: 'absolute',
                    bottom: 0,
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
              <div style={{ backgroundColor: '#fff', padding: '2rem', borderRadius: '15px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
                ...
                <p style={{ color: '#666', marginBottom: '1.5rem' }}>
                  Nossa especialidade original desde a década de 60. Diagnóstico completo e reparos precisos.
                </p>
                <button
                  style={{
                    backgroundColor: '#FFD700',
              ...
              <div style={{ backgroundColor: '#fff', padding: '2rem', borderRadius: '15px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
                ...
                <p style={{ color: '#666', marginBottom: '1.5rem' }}>
                  Técnicos certificados Delphi. Diagnóstico avançado com equipamentos de última geração.
                </p>
                <button
                  style={{
                    backgroundColor: '#FFD700',
              ...
              <div style={{ backgroundColor: '#fff', padding: '2rem', borderRadius: '15px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
                ...
                <p style={{ color: '#666', marginBottom: '1.5rem' }}>
                  Reparos completos, retífica e usinagem com precisão. Experiência em todas as marcas.
                </p>
                <button
                  style={{
                    backgroundColor: '#FFD700',
              ...
              <div style={{ backgroundColor: '#fff', padding: '2rem', borderRadius: '15px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
                ...
                <p style={{ color: '#666', marginBottom: '1.5rem' }}>
                  Manutenção completa do sistema de climatização. Carga de gás e limpeza.
                </p>
                <button
                  style={{
                    backgroundColor: '#FFD700',
              ...
              <div style={{ backgroundColor: '#fff', padding: '2rem', borderRadius: '15px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
                ...
                <p style={{ color: '#666', marginBottom: '1.5rem' }}>
                  Manutenção e reparo de câmbio manual e automático. Diagnóstico preciso.
                </p>
                <button
                  style={{
                    backgroundColor: '#FFD700',
              ...
              <div style={{ backgroundColor: '#fff', padding: '2rem', borderRadius: '15px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
                ...
                <p style={{ color: '#666', marginBottom: '1.5rem' }}>
                  Sistema de freios completo. Pastilhas, discos, cilindros e fluidos.
                </p>
                <button
                  style={{
                    backgroundColor: '#FFD700',
              ...
              <div style={{ backgroundColor: '#fff', padding: '2rem', borderRadius: '15px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
                ...
                <p style={{ color: '#666', marginBottom: '1.5rem' }}>
                  Amortecedores, molas, buchas e todo o sistema de suspensão.
                </p>
                <button
                  style={{
                    backgroundColor: '#FFD700',
              ...
              <div style={{ backgroundColor: '#fff', padding: '2rem', borderRadius: '15px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
                ...
                <p style={{ color: '#666', marginBottom: '1.5rem' }}>
                  Arrefecimento, velas, lubrificação, escapamento, rodas e pneus.
                </p>
                <button
                  style={{
                    backgroundColor: '#FFD700',
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
              ...
              <div style={{ backgroundColor: '#f9f9f9', padding: '2rem', borderRadius: '15px', boxShadow: '0 4px 15px rgba(0,0,0,0.1)' }}>
                ...
                <p style={{ color: '#666', fontSize: '0.85rem', marginTop: '0.8rem', marginBottom: '0.8rem' }}>
                  Clique para conversar diretamente
                </p>

                <a
                  href="tel:+551140630515"
                  style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem', marginBottom: '2rem' }}>
            ...
            <div>
              ...
              <p style={{ color: '#ccc', fontSize: '0.9rem', margin: '0.5rem 0' }}>
                📱 WhatsApp: (11) 94063-0515
              </p>
              <p style={{ color: '#ccc', fontSize: '0.9rem', margin: '0.5rem 0' }}>
                📞 Telefone: (11) 4063-0515
              </p>
              <p style={{ color: '#ccc', fontSize: '0.9rem', margin: '0.5rem 0' }}>
                📍 Av. do Cursino, 2012
              </p>
          ...
          <div style={{ borderTop: '1px solid #333', paddingTop: '2rem' }}>
            <p style={{ marginBottom: '1rem' }}>
              © {currentYear} Auto Check Saúde. Todos os direitos reservados.
            </p>
            <p style={{ fontSize: '0.9rem', color: '#888' }}>
